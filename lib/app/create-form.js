...
async function mainCreate(parsedArgs, csrfToken, cookies, baseUrl, cookieData) {
  ...
  if (configResult && configResult.success) {
    ...
    console.log(JSON.stringify({ success: true, formUuid, formTitle, appType, fieldCount: fields.length, url: formUrl, configWarning: configErrorMsg }));
  }
}
...
async function mainUpdate(parsedArgs, csrfToken, cookies, baseUrl, cookieData) {
  ...
  if (configResult && configResult.success) {
    ...
    hint(t('create_form.schema_ok_config_failed'));
    console.log(JSON.stringify({ success: true, formUuid, appType, changesApplied: appliedChanges.length, changes: appliedChanges, url: formUrl, configWarning: configErrorMsg }));
  }
}
